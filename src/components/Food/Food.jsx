      ...
      <div className="max-w-[1100px] mx-auto my-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-11  place-content-center font-poppins ">
          {item.map((product) => (
            <div
              key={product.id}
              className="w-64 h-auto border-2 border-black rounded-2xl text-center mx-auto px-2 hover:scale-105 duration-300 py-3 "
            >
              <img
                src={product.image}
                alt="/"
              ...
              <button
                ...
                className="my-2 bg-black hover:bg-slate-600"
              >
                Add To Cart
              </button>
            </div>
